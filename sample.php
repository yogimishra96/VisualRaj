                          ...
                          //   d3.select("#n_wound").text(sum_n_wound);
                            ...
                            svg.selectAll("path")
                                    ...
                                    .on("mouseover", function (d, i) {
                                        ...
                                        var n_inc = rel_data.map(function (d) {
                                            return d.n_inc
                                        });
                                        var sum_kill = rel_data.map(function (d) {
                                            return d.sum_kill
                                        });
                                        var sum_wound = rel_data.map(function (d) {
                                            return d.sum_wound
                                        });
            ...
            <div class="container">
                <div class="row">
                    <div class="col l12 s12">
                        ...
                        <span class="Note">This is a district level heat map based on total casualties from bombing incidents in a particular year. Due to a highly positively skewed distribution of casualties across districts, color gradients on the map are scaled logarithmically.</span>
                    </div>
